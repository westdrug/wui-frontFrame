        ...
        'emoji': function (context) {
            ...
            context.memo('button.emoji', function () {
                ...
                var button = ui.button({
                    contents: '<i class="fa fa-smile-o"/> <span class="note-icon-caret"></span>',
                    tooltip: '表情包',
                    click: function () {
                        if(document.emojiSource === undefined)
                            document.emojiSource = '';
                        var buttonX = this.getBoundingClientRect().left+document.documentElement.scrollLeft,
                            buttonY = this.getBoundingClientRect().top+document.documentElement.scrollTop;
            ...
            this.initialize = function () {
                this.$panel = $('<div class="dropdown-menu dropdown-keep-open emoji-dialog animated fadeInUp" id="emoji-dropdown">' +
                    ...
                    '<div class="col-md-12">' +
                    '<h2 class="m-0-t">表情包 <i class="fa fa-times pull-right cursor-pointer closeEmoji"></i></h2>' +
